...
#define CHAT_MAX_SUGGESTIONS 12
...
struct rr_game_chat
{
    ...
    char sending[64];
    char suggestions[CHAT_MAX_SUGGESTIONS][64];
    uint8_t suggestion_count;
    uint8_t selected_suggestion;
    uint8_t suggestion_has_id[CHAT_MAX_SUGGESTIONS];
    uint16_t suggestion_ids[CHAT_MAX_SUGGESTIONS];
};
...
struct rr_dev_cheats
{
    ...
    float give_petal_id;
    float give_petal_rarity;
    char give_petal_id_text[32];
    char give_petal_rarity_text[16];
