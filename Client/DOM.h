...
uint32_t rr_dom_get_selection_start(char const *);
void rr_dom_set_selection_start(char const *, uint32_t);
void rr_dom_set_style(char const *, char const *, char const *);
