...
static void rr_renderer_draw_sandstone_layer(struct rr_renderer *renderer,
                                              float cx, float cy,
...
void rr_sandstone_outer_draw(struct rr_renderer *renderer)
{
    rr_renderer_draw_sandstone_layer(renderer, 0.0f, 0.0f, 190.0f, 6, 0.25f,
                                     0xffd5c7a6, 0xffd5c7a6);
}
void rr_sandstone_middle_draw(struct rr_renderer *renderer)
{
    rr_renderer_draw_sandstone_layer(renderer, 0.0f, 0.0f, 130.0f, 6, 0.25f,
                                     0xffbfb295, 0xffbfb295);
}
void rr_sandstone_inner_draw(struct rr_renderer *renderer)
{
    rr_renderer_draw_sandstone_layer(renderer, 0.0f, 0.0f, 66.0f, 6, 0.25f,
